      ...
      <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
        <div className="w-full max-w-md bg-gray-800 border border-gray-700 rounded-lg p-6">
          <div className="text-center mb-6">
            ...
            <h1 className="text-2xl font-bold text-white">Welcome to Biuld</h1>
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <button disabled={loading || !username || !password} className="w-full mt-2 py-2 rounded bg-blue-600 hover:bg-blue-700 text-white disabled:opacity-50">
          ...
          <div className="mt-3 flex justify-center">
            <a href="/auth/register" className="inline-flex items-center px-3 py-2 rounded border border-gray-600 text-gray-200 hover:bg-gray-700 text-sm">Create account</a>
          </div>
        </div>
      </div>
    </>
